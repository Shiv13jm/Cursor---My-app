...
export default function Playground() {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    // Navigate to protected route with the API key as a query parameter
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-all font-mono text-sm"
                  required
                />
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-400 hover:to-purple-400 text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-violet-500/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none"
            >
              {loading ? (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Your API key will be validated against our database. Valid keys will grant access to protected resources, while invalid keys will be rejected.
                </p>
              </div>
            </div>
          </div>
